...
public class ApiErrorMessage {
    ...
    public ApiErrorMessage(HttpStatus status, int code, String url, List<String> errors) {
        this.status = status;
        this.code = code;
        this.url = url;
        this.errors = errors;
    ...
    public ApiErrorMessage( int code, String url, List<String> errors) {
        this.code = code;
        this.url = url;
        this.errors = errors;
         DateTimeFormatter FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSSSSS Z");
    ...
    public ApiErrorMessage(HttpStatus status, int code, String timestamp, String url, List<String> errors) {
        this.status = status;
        this.code = code;
