...
//	}
	...
	// User user = ((UserPrincipal) this.getPrincipal()).getUser();
	// return this.permissionCheck.checkIsCourseAuthorOrIsRegisteredCourse(lessonID,
	// user.getUserID());
	// }
	//
	// public boolean isCourseAuthorByChapterID(String chapterID) {
	// User user = ((UserPrincipal) this.getPrincipal()).getUser();
	// return this.permissionCheck.isCourseAuthorByChapterID(user.getUserID(),
	// chapterID);
	// }
	//
	// public boolean isCourseAuthorByLessonID(String lessonID) {
	// User user = ((UserPrincipal) this.getPrincipal()).getUser();
	// return this.permissionCheck.isCourseAuthorByLessonID(lessonID,
	// user.getUserID());
	//
	// }
	//
	...
	// User user = ((UserPrincipal) this.getPrincipal()).getUser();
	// return this.permissionCheck.isRegisteredCourseFromLesson(user.getUserID(),
	// lessonID);
	// }
